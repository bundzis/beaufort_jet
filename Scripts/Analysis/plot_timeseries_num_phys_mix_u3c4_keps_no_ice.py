...
#   is using the k-epsilon vertical mixing scheme with u3c4 horizontal advection scheme and no ice
...
path_const_u3c4_keps_no_ice = glob.glob('/global/cfs/cdirs/m4572/dylan617/beaufort_jet/runs/roms_avg_no_ice_500m_w_dvd_constant_forcing_u3c4_keps_*.nc')
# Constant forcing, 


# Load in the output from above with xroms
ds, grid = open_mfroms(path_const_u3c4_keps_no_ice)
...
roms_phy_num_mix_salt_temp = xr.Dataset(
    ...
    attrs=dict(description='Time-series ROMS output including physical and numerical mixing of salinity and temperature from 2-hourly model output; uses /global/cfs/cdirs/m4572/dylan617/beaufort_jet/runs/roms_avg_no_ice_500m_w_dvd_constant_forcing_u3c4_keps_*.nc')
)
...
roms_phy_num_mix_salt_temp.to_netcdf('/global/cfs/cdirs/m4572/bundzis/roms_idealized_beaufort_jet/Post_process_data/roms_phy_num_mix_salt_temp_2hr_ice_500m_const_forc_u3c4_keps_no_ice_001.nc')
# Run without ice
