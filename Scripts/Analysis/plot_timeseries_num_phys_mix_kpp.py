...
ds, grid = open_mfroms(path_const_u3c4_kpp)
...
roms_phy_num_mix_salt_temp.to_netcdf('/global/cfs/cdirs/m4572/bundzis/roms_idealized_beaufort_jet/Post_process_data/roms_phy_num_mix_salt_temp_2hr_ice_500m_const_forc_u3c4_kpp_001.nc')
# Run without ice
