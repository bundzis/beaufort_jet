...
#define ROMS_MODEL
#define BEAUFORT_JET_ICE_W_DVD_KPP
...
# define RI_HORAVG        /* TXLA needed this to be stable */
# define RI_VERAVG        /* TXLA needed this to be stable */
#endif
...
/* ANA files do not work as well as forcing files */
#undef ANA_CLOUD
#undef ANA_TAIR
#undef ANA_HUMIDITY
#undef ANA_RAIN
